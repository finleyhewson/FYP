...
class rs_d435:
    ...
    def getFrame(self):
        ...
        #colorizer.colorize() if you want to add colour to the depth image, put before depth_frame.get_data
 ...
 #       depth_points = self.shrink(depth_points)
    ...
    def deproject_frame( self, frame ):
        ...
        #gets rid of points that are placed at the camera where there isn't any actual data
...
#            threeDFrame = d435Obj.deproject_frame(frame[0])
